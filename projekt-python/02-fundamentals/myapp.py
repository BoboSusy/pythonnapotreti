...
print("Světlo urazí vzdálenost 300 000 km za " + str(phy.time_by_light_speed(300000, SPEED_OF_LIGHT)) + "s")

print("Zvuk urazí vzdálenost 3 000 km za " + str(round(phy.time_by_sound_speed(3000, SPEED_OF_SOUND))) + "s")
