...
writers = {
  "writer1": {
    ...
    "born":1899,
    "books":list(("The Torrents of Spring", "The Sun Also Rises", "A Farewell to Arms", "Winner Take Nothing")),
    "genres":list(("Modernist", "Impresionismus", "Pointilismus")),
    "nationality":"Dutch",
    "most famous work": "The old man and the sea",
  },
  "writer2":{
    "name":("George","Orwell"),
    "born":1903,
    "books":list(("1984", "Animal Farm", "The Road to Wigan Pier")),
    "genres":list(("Dystopia", "roman", "satire")),
    "nationality":"English",
    "most famous work": "Animal Farm",

  },
  "writer3": {
    "name": ("Jaroslav", "Hašek"),
    "born": 1883,
    "books": list(("Osudy dobrého vojáka švejka za světové války", "Můj obchod se psy", "Trampoty pana Tenkráta")),
    "genres": list(("Modernist", "Expresionism")),
    "nationality": "Czech",
    "most famous work": "Osudy dobrého vojáka švejka za světové války",
  }
}
del writers["writer3"]
writers["writer4"] = {
  "name": ("Karel", "Čapek"),
  "born": 1890,
  "books": list(("R.U.R", "Bílá Nemoc", "Válka s mloky","Věc Makropulos")),
  "genres": list(("Modernist", "Science-fiction")),
  "nationality": "Czech",
  "most famous work": "R.U.R",
}
print(writers)